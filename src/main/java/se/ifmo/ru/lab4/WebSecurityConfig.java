...
//                .antMatchers("/api/authorization/signup","/api/authorization/signin","/api/authorization/logout").permitAll()
...
//                .logout()
//                .permitAll()
//                .logoutRequestMatcher(new AntPathRequestMatcher("/api/authorization/logout", "POST"))
//                .and()
